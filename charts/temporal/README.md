...
| certifcates.annotations | object | `{}` |  |
| certifcates.enabled | bool | `false` |  |
| certifcates.isssue.name | string | `"temporal-issuer"` |  |
| certifcates.isssue.secretName | string | `"tls-certs"` |  |
| certifcates.name | string | `"temporal-cert"` |  |
| certifcates.privateKey.algorithm | string | `"RSA"` |  |
| certifcates.privateKey.rotationPolicy | string | `"Always"` |  |
| certifcates.privateKey.size | int | `2048` |  |
| certifcates.secret.name | string | `"temporal-tls-certs"` |  |
| debug | bool | `false` |  |
